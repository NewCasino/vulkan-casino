				...
				<aside class="left">
							<ul class="game-menu">
								...
								<li class="slot"><a class="folder-name" href="/ru/slots">Слоты</a></li>
										<li class="roul active"><a class="folder-name" href="/ru/roulettes">Рулетки</a></li>
												<li class="card"><a class="folder-name" href="/ru/cards">Карточные</a></li>
													</ul>
													</aside>
													...
													<div class="section">
																			<header>
						<div class="in">
							<a class="title" href="<?=$groupGames['id=15']; ?>"><span class="inner">Рулетки</span></a>
						</div>
						</header>
						<div class="items">
