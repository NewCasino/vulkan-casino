...
$title = "Редактировать информацию по играм";
$menu = "games";
...
$data = $mGames->GetGameInfo($_GET['id']);
$data['characteristics'] = unserialize($data['characteristics']);
$data['screenshots'] = unserialize($data['screenshots']);
...
include_once("content/V_EditGameInfo.php");