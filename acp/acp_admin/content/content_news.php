...
if ( $режим == "addnews" )
{
	echo "
		...
		<script type='text/javascript' src='templates/js/uploadnews.js'></script>
	";
    echo "     <TD vAlign=top>\r\n       <TABLE cellSpacing=0 cellPadding=0 width=\"100%\" border=0><!--begin top row-->\r\n         <TBODY>\r\n         <TR>\r\n           <TD><IMG height=13\r\n             src=\"templates/images/spacer.gif\"></TD></TR>\r\n         <TR class=printHidden>\r\n           <TD class=bannerline><IMG height=5\r\n             src=\"templates/images/spacer.gif\" width=2></TD></TR><!--end top row-->\r\n         <TR><!--begi";
    echo "n top banner-->\r\n           <TD class=banner height=40><!--add the tab navigation -->\r\n             <TABLE class=printHidden style=\"MARGIN-LEFT: 10px\" cellSpacing=0\r\n             cellPadding=0 border=0>\r\n               <TBODY>\r\n               <TR><!--section header-->\r\n                 <TD align=left>\r\n                   <DIV id=container>";
    echo "<S";
...
?>	
	...
	<tr>
		<TD valign='top' style='border-top: 1px solid #ccc;'>
			<div id="upload" ><span>Загрузить новый рисунок<span></div>
			<span id="status" ></span>
			<strong>url<strong><br/>
			<input type='text' value='' size='45' class='img_src'>
			<div class='preview'>
			</div>
		</TD>
