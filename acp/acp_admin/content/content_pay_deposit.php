...
if ( $режим == "pending" )
{
    ...
    echo "PAN class=pageheader>Финансы > ";
    echo "<S";
    echo "PAN class=subhead>Внесли </SPAN></SPAN><BR><BR>\r\n                   <UL id=nav>\r\n                     <LI><A class=selected href=\"admin_pay_deposit.php?mode=pending\">В ожидании (";
    echo mysql_num_rows( @mysql_query( "SELECT * FROM pay_deposits WHERE status='2'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=complied\">Оплаченно (";
    echo mysql_num_rows( @mysql_query( "SELECT * FROM pay_deposits WHERE status='1'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=decline\">Отклонённые (";
    ...
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=error\">Незавершенные (";
    echo mysql_num_rows( @mysql_query( "SELECT * FROM pay_deposits WHERE status='0'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php\">Все (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits" ) );
    echo ")</A>\r\n \t\t\t\t  </UL></DIV></TD></TR></TBODY></TABLE><!--end of tab navigation--></TD></TR><!--end banner -->\r\n         <TR><!--begin main content tables --->\r\n           <TD vAlign=top>\r\n             <TABLE cellSpacing=0 cellPadding=0 width=\"100%\">\r\n               <TBODY>\r\n               <TR>\r\n                 <TD width=10><IMG height=8\r\n                   src=\"templates/images/spacer.gif\"\r\n                 width=10>";
    echo "</TD>\r\n                 <TD>               </TD></TR></TBODY></TABLE>\r\n             ";
    echo "<S";
...
if ( $режим == "complied" )
{
    ...
    echo "PAN class=subhead>Внесли </SPAN></SPAN><BR><BR>\r\n                   <UL id=nav>\r\n                     <LI><A href=\"admin_pay_deposit.php?mode=pending\">В ожидании (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='2'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A class=selected href=\"admin_pay_deposit.php?mode=complied\">Оплаченно (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='1'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=decline\">Отклонённые (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='3'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=error\">Незавершенные (";
...
if ( $режим == "decline" )
{
    ...
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=complied\">Оплаченно (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='1'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A class=selected href=\"admin_pay_deposit.php?mode=decline\">Отклонённые (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='3'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=error\">Незавершенные (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='0'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php\">Все (";
...
if ( $режим == "error" )
{
    ...
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=decline\">Отклонённые (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='3'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A class=selected href=\"admin_pay_deposit.php?mode=error\">Незавершенные (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='0'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php\">Все (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits" ) );
    echo ")</A>\r\n \t\t\t\t  </UL></DIV></TD></TR></TBODY></TABLE><!--end of tab navigation--></TD></TR><!--end banner -->\r\n         <TR><!--begin main content tables --->\r\n           <TD vAlign=top>\r\n             <TABLE cellSpacing=0 cellPadding=0 width=\"100%\">\r\n               <TBODY>\r\n               <TR>\r\n                 <TD width=10><IMG height=8\r\n                   src=\"templates/images/spacer.gif\"\r\n                 width=10>";
...
if ( $режим == "login" && $id != "" && $id_фильтер == true )
{
    ...
    echo ")</A>\r\n\t\t\t\t\t <LI><A href=\"admin_pay_deposit.php?mode=error\">Незавершенные (";
    echo mysql_num_rows( mysql_query( "SELECT * FROM pay_deposits WHERE status='0'" ) );
    echo ")</A>\r\n\t\t\t\t\t <LI><A class=selected href=\"admin_pay_deposit.php?mode=login&id=";
    echo $id;
    echo "\">Все: ";
