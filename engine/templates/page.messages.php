...
if ( $_SESSION['login'] == "" ) {
  ...
  if ($id_режим == "view" && $id != "" && $id_фильтер == true) {
      ...
      if (mysql_num_rows($r) == 0) {
          ...
          echo "\t\t\t\t<table cellspacing=0 cellpadding=0 style='width: 910px;>\r\n\t\t\t\t\t\t\t\t<tbody>\r\n\t\t\t\t";
          while ($rr = mysql_fetch_object($r)) {
              ++$cnt;
              if ($rr->userid) {
                  $type = "Сообщение";
          ...
          echo "\t\t\t        <table border=0 style='width: 910px;>\r\n\t\t\t        <form method=post action='/";
          echo $_SESSION['language'];
          ...
          echo $id;
          echo ">\r\n\t\t\t\t        <tr><td valign=top>Сообщение:</td><td><textarea name=message class=\"input\" cols=111 rows=6>";
          echo $message;
          echo "</textarea></td></tr>\r\n\t\t\t\t        <tr><td colspan=2 align=center bgcolor=";
          echo $font_head;
