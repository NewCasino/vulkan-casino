<?php
  ...
  if ($_SESSION['login'] != "") {
      ...
      if ($action == "1") {
		  ...
		  if ($вывод_сумма && $clients_query['cash'] < $вывод_сумма) {
              $error .= "Сумма вывода не может быть больше баланса!\\n";
          }
          if ($вывод_тип == "") {
          ...
          if ($error == "") {
              ...
              echo "<script>alert(\"Запрос на вывод прошел успешно! Ожидайте обработки вашего запроса, согласно правилам!\");</script>";
